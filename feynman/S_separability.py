...
def check_separability_plus( filename):
    try:
...
def do_separability_plus( filename, list_i,list_j):
    try:
        pathdir_weights = "results/NN_trained_models/models/"
...
def check_separability_multiply( filename):
    try:
        pathdir_weights = "results/NN_trained_models/models/"
...
def do_separability_multiply( filename, list_i,list_j):
    try:
        pathdir_weights = "results/NN_trained_models/models/"
